...
SELECT
	...
	ej.ELO 
FROM JOGADOR j 
INNER JOIN ELO_JOGADOR ej ON ej.JOGADOR = j.USERNAME;

UPDATE AMDB.PARTIDA 
SET VENCEDOR='jantuscara' 
WHERE PARTIDA.DESAFIADO = 'jantuscara' 
 AND PARTIDA .DESAFIANTE = 'time_1' 
 AND PARTIDA .TORNEIO = '1011';
 
UPDATE AMDB.TIMES 
SET CAPITAO = 'jogador1' 
WHERE NOME = 'time_1';

UPDATE AMDB.TIMES 
SET CAPITAO = 'jogador11' 
WHERE NOME = 'time_2';

DELETE FROM AMDB.PARTIDA
WHERE TORNEIO = '1010' 
 AND DESAFIANTE = 'time_1' 
 AND DESAFIADO = 'jantuscara' 
 AND ( PARTIDA BETWEEN TO_DATE(nvl('','06/12/2020 10:00:00'),'DD/MM/YYYY HH24:MI:SS') 
					AND TO_DATE(nvl('','06/12/2020 11:0:00'),'DD/MM/YYYY HH24:MI:SS'));

DELETE FROM AMDB.JOGADOR
WHERE USERNAME IN (
	SELECT J.USERNAME
	FROM JOGADOR J 
